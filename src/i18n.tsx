...
const dictionaries: Record<UiLocale, Record<string, string>> = {
  en: {
    ...
    "onboarding.ariaLabel": "Gesture guide",
    "onboarding.tapTitle": "Tap the screen",
    "onboarding.brightnessTitle": "Slide up or down at the left edge",
    "onboarding.volumeTitle": "Slide up or down at the right edge",
    "onboarding.playerTitle": "Swipe down",
    "onboarding.menuTitle": "Touch and hold",
    ...
    "settings.careDesc": "Guarded player reset, restart, and shutdown actions.",
    ...
    "settings.screenSleep": "Screen Saver",
    "settings.screenSleepMeta": "Touch to exit.",
    ...
    "settings.wizard": "Help",
    "settings.startupGuide": "Gesture guide",
    "settings.wizardMeta": "Review the touchscreen gestures.",
    "settings.openWizard": "Open guide",
    ...
    "settings.resetProviderProfile": "Reset player login",
    "settings.resetProviderProfileAction": "Reset login",
    "settings.resetProviderProfileMeta": "Clears {provider} account, cookies, and cache. Other players stay signed in.",
    "settings.resetProviderProfileUnavailable": "No player selected",
    "settings.resetProviderProfileUnavailableMeta": "Open a web player first to reset its login state.",
    "settings.tapAgainResetProviderProfile": "Tap again to reset {provider}",
...
Object.assign(dictionaries["zh-CN"], {
  ...
  "quickMenu.title": "快捷菜单", "quickMenu.close": "关闭快捷菜单", "quickMenu.screen": "屏幕", "quickMenu.turnScreenOff": "关闭屏幕", "quickMenu.turnScreenOn": "打开屏幕", "quickMenu.volume": "音量", "quickMenu.mute": "静音", "quickMenu.restoreVolume": "恢复音量", "quickMenu.time": "时间", "quickMenu.hideTime": "隐藏时间", "quickMenu.showTime": "显示时间", "quickMenu.sleep": "睡眠", "quickMenu.sleepTikpal": "让 Tikpal 休眠", "quickMenu.tapToSleep": "点击休眠", "startup.setRoomMood": "设置房间氛围", "startup.roomModes": "启动房间模式", "onboarding.ariaLabel": "手势指南", "onboarding.title": "欢迎使用 Tikpal", "onboarding.subtitle": "几个手势就能快速上手。", "onboarding.tapTitle": "轻点屏幕", "onboarding.tapBody": "显示控制按钮", "onboarding.brightnessTitle": "左边缘上下滑动", "onboarding.brightnessBody": "调节屏幕亮度", "onboarding.volumeTitle": "右边缘上下滑动", "onboarding.volumeBody": "调节播放音量", "onboarding.playerTitle": "向下滑动", "onboarding.playerBody": "在主界面打开播放页", "onboarding.menuTitle": "长按屏幕", "onboarding.menuBody": "打开快捷菜单", "onboarding.footer": "之后可在设置中重新打开此引导。", "onboarding.getStarted": "开始使用",
  "settings.console": "控制台", "settings.preferences": "偏好", "settings.library": "曲库", "settings.link": "连接", "settings.care": "维护", "settings.careDesc": "受保护的网页播放器重置、重启与关机操作。", "settings.language": "语言", "settings.languageMeta": "界面与键盘", "settings.languageDetail": "选择 Tikpal 界面语言。键盘默认英文，语言键直接切到当前语言。", "settings.languageSaved": "语言已保存。", "settings.languageSavedWithWarning": "语言已保存。键盘稍后同步。", "settings.audioOutput": "音频输出", "settings.dsp": "DSP", "settings.eqReady": "EQ 就绪", "settings.display": "显示", "settings.timeNight": "时间与夜间", "settings.localLibrary": "本地曲库", "settings.savedOnDevice": "保存在本机的音乐", "settings.nasSources": "NAS 来源", "settings.addNas": "添加 NAS", "settings.usb": "USB", "settings.notMounted": "未挂载", "settings.libraryScan": "曲库扫描", "settings.scanLibrary": "扫描曲库", "settings.font": "字体", "settings.skin": "皮肤", "settings.lyrics": "歌词", "settings.system": "系统", "settings.restart": "重启", "settings.shutdown": "关机", "settings.confirmNeeded": "需要确认", "settings.restartSystem": "重启系统", "settings.shutdownSystem": "关闭系统", "settings.tapAgainRestart": "再点一次重启", "settings.tapAgainPowerOff": "再点一次关机", "settings.resetProviderProfile": "重置网页播放器登录状态", "settings.resetProviderProfileAction": "重置登录状态", "settings.resetProviderProfileMeta": "清除 {provider} 的账号、Cookie 和缓存，其他服务不受影响。", "settings.resetProviderProfileUnavailable": "未选择网页播放器", "settings.resetProviderProfileUnavailableMeta": "先打开一个网页播放器，才可重置其登录状态。", "settings.tapAgainResetProviderProfile": "再点一次重置 {provider}", "settings.tracks": "{count} 首", "settings.savedCount": "{count} 个已保存",
...
Object.assign(dictionaries.it, {
  ...
  "handoff.title": "Connessione", "handoff.body": "Connettiti dal telefono. Torna quando parte la musica.", "room.focusIntent": "Lavoro e lettura", "room.calmIntent": "Relax", "room.sleepIntent": "Scuro, timer, dissolvenza", "room.hifiIntent": "Ascolto puro", "quickMenu.title": "Menu rapido", "quickMenu.close": "Chiudi menu rapido", "quickMenu.turnScreenOff": "Spegni schermo", "quickMenu.turnScreenOn": "Accendi schermo", "quickMenu.mute": "Muto", "quickMenu.restoreVolume": "Ripristina volume", "quickMenu.hideTime": "Nascondi ora", "quickMenu.showTime": "Mostra ora", "quickMenu.sleepTikpal": "Metti Tikpal in sleep", "startup.setRoomMood": "Imposta atmosfera", "startup.roomModes": "Modalità iniziali", "onboarding.ariaLabel": "Guida ai gesti", "onboarding.title": "Benvenuto in Tikpal", "onboarding.subtitle": "Con pochi gesti il kiosk diventa subito naturale.", "onboarding.tapTitle": "Tocca lo schermo", "onboarding.tapBody": "Mostra i controlli di riproduzione", "onboarding.brightnessTitle": "Scorri su e giù sul bordo sinistro", "onboarding.brightnessBody": "Regola la luminosità dello schermo", "onboarding.volumeTitle": "Scorri su e giù sul bordo destro", "onboarding.volumeBody": "Regola il volume di riproduzione", "onboarding.playerTitle": "Scorri verso il basso", "onboarding.playerBody": "Apri Player dalla schermata principale", "onboarding.menuTitle": "Tieni premuto", "onboarding.menuBody": "Apri il menu rapido", "onboarding.footer": "Puoi riaprire questa guida più tardi dalle impostazioni.", "onboarding.getStarted": "Inizia",
...
Object.assign(dictionaries.ko, {
  ...
  "handoff.title": "연결 중", "handoff.body": "폰에서 연결하세요. 재생이 시작되면 돌아옵니다.", "room.focusIntent": "작업과 독서", "room.calmIntent": "휴식", "room.sleepIntent": "어둡게, 타이머, 페이드아웃", "room.hifiIntent": "순수 음악 감상", "quickMenu.title": "빠른 메뉴", "quickMenu.close": "빠른 메뉴 닫기", "quickMenu.turnScreenOff": "화면 끄기", "quickMenu.turnScreenOn": "화면 켜기", "quickMenu.mute": "음소거", "quickMenu.restoreVolume": "볼륨 복원", "quickMenu.hideTime": "시간 숨기기", "quickMenu.showTime": "시간 표시", "quickMenu.sleepTikpal": "Tikpal 절전", "startup.setRoomMood": "룸 분위기 설정", "startup.roomModes": "시작 룸 모드", "onboarding.ariaLabel": "제스처 안내", "onboarding.title": "Tikpal에 오신 것을 환영합니다", "onboarding.subtitle": "몇 가지 손동작만 익히면 키오스크를 바로 자연스럽게 사용할 수 있습니다.", "onboarding.tapTitle": "화면 탭하기", "onboarding.tapBody": "재생 컨트롤 표시", "onboarding.brightnessTitle": "왼쪽 가장자리에서 위아래로 쓸기", "onboarding.brightnessBody": "화면 밝기 조절", "onboarding.volumeTitle": "오른쪽 가장자리에서 위아래로 쓸기", "onboarding.volumeBody": "재생 음량 조절", "onboarding.playerTitle": "아래로 쓸기", "onboarding.playerBody": "홈 화면에서 Player 열기", "onboarding.menuTitle": "화면 길게 누르기", "onboarding.menuBody": "빠른 메뉴 열기", "onboarding.footer": "이 안내는 나중에 설정에서 다시 열 수 있습니다.", "onboarding.getStarted": "시작하기",
...
Object.assign(dictionaries.de, {
  ...
  "settings.screenSleep": "Bildschirmschoner",
  "settings.screenSleepMeta": "Tippen zum Beenden.",
...
Object.assign(dictionaries.it, {
  ...
  "settings.screenSleep": "Screensaver",
  "settings.screenSleepMeta": "Tocca per uscire.",
...
Object.assign(dictionaries.ko, {
  ...
  "settings.screenSleep": "화면 보호기",
  "settings.screenSleepMeta": "터치하여 종료합니다.",
...
Object.assign(dictionaries.ja, {
  ...
  "settings.screenSleep": "スクリーンセーバー",
  "settings.screenSleepMeta": "タッチで終了します。",
...
Object.assign(dictionaries.es, {
  ...
  "settings.screenSleep": "Protector de pantalla",
  "settings.screenSleepMeta": "Toca para salir.",
...
Object.assign(dictionaries.en, {
  ...
  "settings.linkDesc": "Network, remote, and web players.",
  "settings.careDesc": "Restart and power controls.",
  "settings.screenSleepOn": "Screen Saver on",
  "settings.screenSleepOff": "Screen Saver off",
...
Object.assign(dictionaries["zh-CN"], {
  ...
  "settings.screenSleepOn": "屏保已开",
  "settings.screenSleepOff": "屏保已关",
...
Object.assign(dictionaries.de, {
  ...
  "settings.screenSleepOn": "Bildschirmschoner an",
  "settings.screenSleepOff": "Bildschirmschoner aus",
...
Object.assign(dictionaries.it, {
  ...
  "settings.careDesc": "Riavvio e alimentazione.",
  "settings.screenSleepOn": "Screensaver attivo",
  "settings.screenSleepOff": "Screensaver disattivo",
...
Object.assign(dictionaries.ko, {
  ...
  "settings.linkDesc": "네트워크, 리모컨, 웹 플레이어.",
  "settings.careDesc": "재시작과 전원 제어.",
  "settings.screenSleepOn": "화면 보호기 켜짐",
  "settings.screenSleepOff": "화면 보호기 꺼짐",
...
Object.assign(dictionaries.ja, {
  ...
  "settings.linkDesc": "ネットワーク、リモート、Webプレイヤー。",
  "settings.careDesc": "再起動と電源操作。",
  "settings.screenSleepOn": "スクリーンセーバー有効",
  "settings.screenSleepOff": "スクリーンセーバー無効",
...
Object.assign(dictionaries.es, {
  ...
  "settings.linkDesc": "Red, remoto y web players.",
  "settings.careDesc": "Reinicio y energia.",
  "settings.screenSleepOn": "Protector activo",
  "settings.screenSleepOff": "Protector desactivado",
...
Object.assign(dictionaries.en, {
  ...
  "onboarding.scopeNote": "Web players use their own controls.",
  "onboarding.returnTitle": "Swipe up",
  ...
  "settings.openWizard": "Open guide",
  "onboarding.tapTitle": "Tap the screen",
  "onboarding.tapBody": "Show playback controls",
  "onboarding.menuTitle": "Touch and hold",
  "onboarding.menuBody": "Open Quick Menu",
  "onboarding.brightnessTitle": "Slide up or down at the left edge",
  "onboarding.brightnessBody": "Adjust screen brightness",
  "onboarding.volumeTitle": "Slide up or down at the right edge",
  "onboarding.volumeBody": "Adjust playback volume",
  "onboarding.playerTitle": "Swipe down",
  "onboarding.playerBody": "Open Player from the home screen",
  "onboarding.returnBody": "Return home from Player or Settings"

});

Object.assign(dictionaries["zh-CN"], {
  "onboarding.ariaLabel": "手势指南",
  ...
  "onboarding.scopeNote": "网页播放器内，请使用页面自带的控件。",
  "onboarding.returnTitle": "向上滑动",
  ...
  "settings.startupGuide": "手势指南",
  "settings.wizard": "帮助",
  "settings.wizardMeta": "查看触屏手势的使用方法。",
  "settings.openWizard": "打开指南",
  "onboarding.tapTitle": "轻点屏幕",
  "onboarding.tapBody": "显示控制按钮",
  "onboarding.menuTitle": "长按屏幕",
  "onboarding.menuBody": "打开快捷菜单",
  "onboarding.brightnessTitle": "左边缘上下滑动",
  "onboarding.brightnessBody": "调节屏幕亮度",
  "onboarding.volumeTitle": "右边缘上下滑动",
  "onboarding.volumeBody": "调节播放音量",
  "onboarding.playerTitle": "向下滑动",
  "onboarding.playerBody": "在主界面打开播放页",
  "onboarding.returnBody": "从播放页或设置返回主界面"

});

Object.assign(dictionaries.de, {
  "onboarding.ariaLabel": "Gestensteuerung",
  ...
  "onboarding.scopeNote": "Webplayer verwenden ihre eigenen Bedienelemente.",
  "onboarding.returnTitle": "Nach oben wischen",
  ...
  "settings.startupGuide": "Gestensteuerung",
  "settings.wizard": "Hilfe",
  "settings.wizardMeta": "Die Touchscreen-Gesten im Überblick.",
  "settings.openWizard": "Anleitung öffnen",
  "onboarding.tapTitle": "Auf den Bildschirm tippen",
  "onboarding.tapBody": "Wiedergabesteuerung anzeigen",
  "onboarding.menuTitle": "Gedrückt halten",
  "onboarding.menuBody": "Schnellmenü öffnen",
  "onboarding.brightnessTitle": "Am linken Rand auf und ab wischen",
  "onboarding.brightnessBody": "Bildschirmhelligkeit anpassen",
  "onboarding.volumeTitle": "Am rechten Rand auf und ab wischen",
  "onboarding.volumeBody": "Wiedergabelautstärke anpassen",
  "onboarding.playerTitle": "Nach unten wischen",
  "onboarding.playerBody": "Player von der Startansicht öffnen",
  "onboarding.returnBody": "Von Player oder Einstellungen zur Startansicht zurückkehren"

});

Object.assign(dictionaries.it, {
  "onboarding.ariaLabel": "Guida ai gesti",
  ...
  "onboarding.scopeNote": "Nei player web, usa i controlli della pagina.",
  "onboarding.returnTitle": "Scorri verso l’alto",
  ...
  "settings.startupGuide": "Guida ai gesti",
  "settings.wizard": "Aiuto",
  "settings.wizardMeta": "Rivedi i gesti per il touchscreen.",
  "settings.openWizard": "Apri la guida",
  "onboarding.tapTitle": "Tocca lo schermo",
  "onboarding.tapBody": "Mostra i controlli di riproduzione",
  "onboarding.menuTitle": "Tieni premuto",
  "onboarding.menuBody": "Apri il menu rapido",
  "onboarding.brightnessTitle": "Scorri su e giù sul bordo sinistro",
  "onboarding.brightnessBody": "Regola la luminosità dello schermo",
  "onboarding.volumeTitle": "Scorri su e giù sul bordo destro",
  "onboarding.volumeBody": "Regola il volume di riproduzione",
  "onboarding.playerTitle": "Scorri verso il basso",
  "onboarding.playerBody": "Apri Player dalla schermata principale",
  "onboarding.returnBody": "Torna alla schermata principale da Player o Impostazioni"

});

Object.assign(dictionaries.ko, {
  "onboarding.ariaLabel": "제스처 안내",
  ...
  "onboarding.scopeNote": "웹 플레이어에서는 페이지의 자체 컨트롤을 사용하세요.",
  "onboarding.returnTitle": "위로 쓸기",
  ...
  "settings.startupGuide": "제스처 안내",
  "settings.wizard": "도움말",
  "settings.wizardMeta": "터치스크린 제스처 사용법을 확인하세요.",
  "settings.openWizard": "안내 열기",
  "onboarding.tapTitle": "화면 탭하기",
  "onboarding.tapBody": "재생 컨트롤 표시",
  "onboarding.menuTitle": "화면 길게 누르기",
  "onboarding.menuBody": "빠른 메뉴 열기",
  "onboarding.brightnessTitle": "왼쪽 가장자리에서 위아래로 쓸기",
  "onboarding.brightnessBody": "화면 밝기 조절",
  "onboarding.volumeTitle": "오른쪽 가장자리에서 위아래로 쓸기",
  "onboarding.volumeBody": "재생 음량 조절",
  "onboarding.playerTitle": "아래로 쓸기",
  "onboarding.playerBody": "홈 화면에서 Player 열기",
  "onboarding.returnBody": "Player나 설정에서 홈 화면으로 돌아가기"

});

Object.assign(dictionaries.ja, {
  "onboarding.ariaLabel": "ジェスチャーガイド",
  "onboarding.tapTitle": "画面をタップ",
  "onboarding.brightnessTitle": "左端を上下にスワイプ",
  "onboarding.volumeTitle": "右端を上下にスワイプ",
  "onboarding.playerTitle": "下にスワイプ",
  "onboarding.menuTitle": "画面を長押し",
  ...
  "onboarding.scopeNote": "Webプレイヤーでは、ページ内の操作ボタンをお使いください。",
  "onboarding.returnTitle": "上にスワイプ",
  "onboarding.previous": "前へ",
  "onboarding.next": "次へ",
  "onboarding.getStarted": "使い始める",
  ...
  "settings.startupGuide": "ジェスチャーガイド",
  "settings.wizard": "ヘルプ",
  "settings.wizardMeta": "タッチ操作の使い方を確認できます。",
  "settings.openWizard": "ガイドを開く",
  "onboarding.tapBody": "再生コントロールを表示",
  "onboarding.menuBody": "クイックメニューを開く",
  "onboarding.brightnessBody": "画面の明るさを調整",
  "onboarding.volumeBody": "再生音量を調整",
  "onboarding.playerBody": "ホーム画面からPlayerを開く",
  "onboarding.returnBody": "Playerや設定からホームに戻る"

});

Object.assign(dictionaries.es, {
  "onboarding.ariaLabel": "Guía de gestos",
  "onboarding.tapTitle": "Toca la pantalla",
  "onboarding.brightnessTitle": "Desliza arriba y abajo por el borde izquierdo",
  "onboarding.volumeTitle": "Desliza arriba y abajo por el borde derecho",
  "onboarding.playerTitle": "Desliza hacia abajo",
  "onboarding.menuTitle": "Mantén pulsado",
  ...
  "onboarding.scopeNote": "En los reproductores web, usa los controles de la página.",
  "onboarding.returnTitle": "Desliza hacia arriba",
  ...
  "settings.startupGuide": "Guía de gestos",
  "settings.wizard": "Ayuda",
  "settings.wizardMeta": "Consulta los gestos de la pantalla táctil.",
  "settings.openWizard": "Abrir guía",
  "onboarding.tapBody": "Muestra los controles de reproducción",
  "onboarding.menuBody": "Abre el menú rápido",
  "onboarding.brightnessBody": "Ajusta el brillo de la pantalla",
  "onboarding.volumeBody": "Ajusta el volumen de reproducción",
  "onboarding.playerBody": "Abre Player desde la pantalla de inicio",
  "onboarding.returnBody": "Vuelve al inicio desde Player o Ajustes"
...
Object.assign(dictionaries.en, {
  "settings.preferencesDesc": "Listening, display, appearance, and language.",
  "settings.link": "Network & Explore",
  "settings.linkDesc": "Device network and Explore web players.",
  "settings.care": "Device & maintenance",
  "settings.careDesc": "Status, maintenance, and power.",
  "settings.appearanceLanguage": "Appearance & language",
  "settings.appearanceLanguageMeta": "{font} · {skin}",
  "settings.appearanceLanguageDetail": "Choose language, font, or skin without leaving Preferences.",
  "settings.openAppearance": "Customize",
  "settings.deviceStatus": "Status & updates",
  "settings.advancedMaintenance": "Advanced maintenance",
  "settings.power": "Power"
});

Object.assign(dictionaries["zh-CN"], {
  "settings.preferencesDesc": "聆听、显示、外观与语言。",
  "settings.link": "网络与 Explore",
  "settings.linkDesc": "设备网络与 Explore 网页播放器。",
  "settings.care": "设备与维护",
  "settings.careDesc": "状态、维护与电源操作。",
  "settings.appearanceLanguage": "外观与语言",
  "settings.appearanceLanguageMeta": "{font} · {skin}",
  "settings.appearanceLanguageDetail": "在偏好中选择语言、字体或皮肤。",
  "settings.openAppearance": "自定义",
  "settings.deviceStatus": "状态与更新",
  "settings.advancedMaintenance": "高级维护",
  "settings.power": "电源"
});

Object.assign(dictionaries.de, {
  "settings.preferencesDesc": "Hören, Display, Erscheinungsbild und Sprache.",
  "settings.link": "Netzwerk & Explore",
  "settings.linkDesc": "Gerätenetzwerk und Explore-Webplayer.",
  "settings.care": "Gerät & Wartung",
  "settings.careDesc": "Status, Wartung und Stromversorgung.",
  "settings.appearanceLanguage": "Erscheinungsbild & Sprache",
  "settings.appearanceLanguageMeta": "{font} · {skin}",
  "settings.appearanceLanguageDetail": "Sprache, Schrift oder Skin in den Einstellungen wählen.",
  "settings.openAppearance": "Anpassen",
  "settings.deviceStatus": "Status & Updates",
  "settings.advancedMaintenance": "Erweiterte Wartung",
  "settings.power": "Stromversorgung"
});

Object.assign(dictionaries.it, {
  "settings.preferencesDesc": "Ascolto, display, aspetto e lingua.",
  "settings.link": "Rete e Explore",
  "settings.linkDesc": "Rete del dispositivo e web player Explore.",
  "settings.care": "Dispositivo e manutenzione",
  "settings.careDesc": "Stato, manutenzione e alimentazione.",
  "settings.appearanceLanguage": "Aspetto e lingua",
  "settings.appearanceLanguageMeta": "{font} · {skin}",
  "settings.appearanceLanguageDetail": "Scegli lingua, carattere o tema nelle Preferenze.",
  "settings.openAppearance": "Personalizza",
  "settings.deviceStatus": "Stato e aggiornamenti",
  "settings.advancedMaintenance": "Manutenzione avanzata",
  "settings.power": "Alimentazione"
});

Object.assign(dictionaries.ko, {
  "settings.preferencesDesc": "감상, 화면, 모양과 언어 설정.",
  "settings.link": "네트워크 및 Explore",
  "settings.linkDesc": "기기 네트워크와 Explore 웹 플레이어.",
  "settings.care": "기기 및 유지 관리",
  "settings.careDesc": "상태, 유지 관리 및 전원.",
  "settings.appearanceLanguage": "모양 및 언어",
  "settings.appearanceLanguageMeta": "{font} · {skin}",
  "settings.appearanceLanguageDetail": "환경설정에서 언어, 글꼴 또는 스킨을 선택하세요.",
  "settings.openAppearance": "사용자화",
  "settings.deviceStatus": "상태 및 업데이트",
  "settings.advancedMaintenance": "고급 유지 관리",
  "settings.power": "전원"
});

Object.assign(dictionaries.ja, {
  "settings.preferencesDesc": "リスニング、表示、外観と言語。",
  "settings.link": "ネットワークと Explore",
  "settings.linkDesc": "端末ネットワークと Explore の Web プレイヤー。",
  "settings.care": "端末とメンテナンス",
  "settings.careDesc": "状態、メンテナンス、電源操作。",
  "settings.appearanceLanguage": "外観と言語",
  "settings.appearanceLanguageMeta": "{font} · {skin}",
  "settings.appearanceLanguageDetail": "環境設定で言語、フォント、スキンを選択します。",
  "settings.openAppearance": "カスタマイズ",
  "settings.deviceStatus": "状態とアップデート",
  "settings.advancedMaintenance": "高度なメンテナンス",
  "settings.power": "電源"
});

Object.assign(dictionaries.es, {
  "settings.preferencesDesc": "Escucha, pantalla, apariencia e idioma.",
  "settings.link": "Red y Explore",
  "settings.linkDesc": "Red del dispositivo y reproductores web de Explore.",
  "settings.care": "Dispositivo y mantenimiento",
  "settings.careDesc": "Estado, mantenimiento y energía.",
  "settings.appearanceLanguage": "Apariencia e idioma",
  "settings.appearanceLanguageMeta": "{font} · {skin}",
  "settings.appearanceLanguageDetail": "Elige idioma, fuente o tema desde Preferencias.",
  "settings.openAppearance": "Personalizar",
  "settings.deviceStatus": "Estado y actualizaciones",
  "settings.advancedMaintenance": "Mantenimiento avanzado",
...
Object.assign(dictionaries.en, {
  ...
  "settings.runtimeSelfCheck": "Explore window & process check", "settings.runtimeSelfCheckRetry": "Check again", "settings.runtimeSelfCheckHealthy": "Check passed", "settings.runtimeSelfCheckHealthyHelp": "The Explore window and supporting process are available. This does not verify website access, account status, regional availability, or playback.", "settings.runtimeSelfCheckHelp": "Checks only the Explore window and supporting process; it does not test websites or playback.",
...
Object.assign(dictionaries["zh-CN"], {
  ...
  "settings.runtimeSelfCheck": "Explore 窗口与进程检查", "settings.runtimeSelfCheckRetry": "再次检查", "settings.runtimeSelfCheckHealthy": "检查通过", "settings.runtimeSelfCheckHealthyHelp": "Explore 窗口和配套进程可用。此检查不验证网站可用性、账号状态、地区限制或实际播放。", "settings.runtimeSelfCheckHelp": "仅检查 Explore 窗口与配套进程；不会测试网站或播放。",
...
Object.assign(dictionaries.de, {
  ...
  "settings.runtimeSelfCheck": "Explore-Fenster- und Prozessprüfung", "settings.runtimeSelfCheckRetry": "Erneut prüfen", "settings.runtimeSelfCheckHealthy": "Prüfung bestanden", "settings.runtimeSelfCheckHealthyHelp": "Explore-Fenster und zugehöriger Prozess sind verfügbar. Dies prüft weder Website-Zugang, Konto, regionale Verfügbarkeit noch Wiedergabe.", "settings.runtimeSelfCheckHelp": "Prüft nur Explore-Fenster und Prozess, nicht Websites oder Wiedergabe.",
...
Object.assign(dictionaries.it, {
  ...
  "settings.runtimeSelfCheck": "Controllo finestra e processo Explore", "settings.runtimeSelfCheckRetry": "Controlla di nuovo", "settings.runtimeSelfCheckHealthy": "Controllo superato", "settings.runtimeSelfCheckHealthyHelp": "La finestra Explore e il processo di supporto sono disponibili. Non verifica sito, account, disponibilità regionale o riproduzione.", "settings.runtimeSelfCheckHelp": "Controlla solo finestra e processo Explore, non siti o riproduzione.",
...
Object.assign(dictionaries.ko, {
  ...
  "settings.runtimeSelfCheck": "Explore 창 및 프로세스 확인", "settings.runtimeSelfCheckRetry": "다시 확인", "settings.runtimeSelfCheckHealthy": "확인 완료", "settings.runtimeSelfCheckHealthyHelp": "Explore 창과 보조 프로세스를 사용할 수 있습니다. 웹사이트, 계정, 지역 제한 또는 실제 재생은 확인하지 않습니다.", "settings.runtimeSelfCheckHelp": "Explore 창과 보조 프로세스만 확인하며 웹사이트나 재생은 테스트하지 않습니다.",
...
Object.assign(dictionaries.ja, {
  ...
  "settings.runtimeSelfCheck": "Explore のウィンドウとプロセスを確認", "settings.runtimeSelfCheckRetry": "もう一度確認", "settings.runtimeSelfCheckHealthy": "確認に合格", "settings.runtimeSelfCheckHealthyHelp": "Explore のウィンドウと補助プロセスを利用できます。サイト、アカウント、地域制限、実際の再生は確認しません。", "settings.runtimeSelfCheckHelp": "Explore のウィンドウと補助プロセスだけを確認し、サイトや再生は確認しません。",
...
Object.assign(dictionaries.es, {
  ...
  "settings.runtimeSelfCheck": "Comprobación de ventana y proceso Explore", "settings.runtimeSelfCheckRetry": "Comprobar de nuevo", "settings.runtimeSelfCheckHealthy": "Comprobación superada", "settings.runtimeSelfCheckHealthyHelp": "La ventana Explore y su proceso de apoyo están disponibles. No verifica sitio web, cuenta, disponibilidad regional ni reproducción.", "settings.runtimeSelfCheckHelp": "Solo comprueba la ventana y el proceso Explore, no sitios web ni reproducción.",
