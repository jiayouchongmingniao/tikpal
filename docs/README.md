...
| [Explore X11 Helper Phase 0](06-deployment/explore-x11-helper-phase0-v1.md) | Read-only daemon gate | Native Helper capability boundary, local regression coverage, and Phase 1 promotion preconditions. |
