...
- Ambient Room Canvas: Focus, Calm, and Sleep center controls show scene previous/next, a six-choice source picker, Scene Sound, and the content-sized mode label/intent strip; they do not show track transport or lyrics. Hi-Fi keeps music transport, lyrics, and the same source picker.
