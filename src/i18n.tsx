...
const dictionaries: Record<UiLocale, Record<string, string>> = {
  en: {
    ...
    "onboarding.tapTitle": "Tap to show controls",
    "onboarding.brightnessTitle": "Slide the left edge for brightness",
    "onboarding.volumeTitle": "Slide the right edge for volume",
    "onboarding.playerTitle": "Swipe down to open Player",
    "onboarding.menuTitle": "Hold to open Quick Menu",
...
Object.assign(dictionaries.en, {
  ...
  "onboarding.returnTitle": "Swipe up in Player or Settings to return home",
...
Object.assign(dictionaries["zh-CN"], {
  ...
  "onboarding.scopeNote": "网页播放器使用自己的控件。",
  "onboarding.returnTitle": "在播放页或设置页上滑，返回主界面",
...
Object.assign(dictionaries.de, {
  ...
  "onboarding.scopeNote": "Webplayer nutzen ihre eigene Steuerung.",
  "onboarding.returnTitle": "In Player oder Einstellungen nach oben zur Startansicht wischen",
...
Object.assign(dictionaries.it, {
  ...
  "onboarding.scopeNote": "I web player usano i propri controlli.",
  "onboarding.returnTitle": "Scorri verso l’alto in Player o Impostazioni per tornare alla schermata principale",
...
Object.assign(dictionaries.ko, {
  ...
  "onboarding.scopeNote": "웹 플레이어는 자체 컨트롤을 사용합니다.",
  "onboarding.returnTitle": "Player나 설정에서 위로 쓸어 홈 화면으로 돌아가기",
...
Object.assign(dictionaries.ja, {
  ...
  "onboarding.tapTitle": "タップして操作を表示",
  "onboarding.brightnessTitle": "左端を上下にスライドして明るさを調整",
  "onboarding.volumeTitle": "右端を上下にスライドして音量を調整",
  "onboarding.playerTitle": "下にスワイプしてPlayerを開く",
  "onboarding.menuTitle": "長押しでクイックメニューを開く",
  ...
  "onboarding.scopeNote": "Webプレイヤーは独自の操作を使います。",
  "onboarding.returnTitle": "Playerや設定で上にスワイプしてホームに戻る",
...
Object.assign(dictionaries.es, {
  ...
  "onboarding.tapTitle": "Toca para mostrar los controles",
  "onboarding.brightnessTitle": "Desliza el borde izquierdo para ajustar el brillo",
  "onboarding.volumeTitle": "Desliza el borde derecho para ajustar el volumen",
  "onboarding.playerTitle": "Desliza hacia abajo para abrir Player",
  "onboarding.menuTitle": "Mantén pulsado para abrir el menú rápido",
  ...
  "onboarding.scopeNote": "Los reproductores web usan sus propios controles.",
  "onboarding.returnTitle": "Desliza hacia arriba en Player o Ajustes para volver al inicio",
