...
export const radioStations: RadioStationSummary[] = [
    ...
    buildRadioStation({
      id: "radio-510",
      label: "Calm - Positively Meditation",
      uri: "https://streaming.positivity.radio/pr/posimeditation/icecast.audio",
      genre: "Calm, Meditation, Healing, Mindfulness",
      bitrateKbps: 128,
      codec: "MP3",
      category: "calm",
      categoryLabel: "Calm",
      tags: ["Meditation", "Healing"],
      broadcaster: "Positivity Radio",
      logoUrl: null,
      catalogSource: "tikpal",
      sortOrder: 510,
      secondaryStatus: "Calm · Positivity Radio · 128 kbps MP3",
      active: false
    }),
    buildRadioStation({
      id: "radio-520",
      label: "Sleep - Ambient Sleeping Pill",
      uri: "http://radio.stereoscenic.com/asp-h",
      genre: "Sleep, Ambient",
      bitrateKbps: 256,
      codec: "MP3",
      category: "sleep",
      ...
      catalogSource: "tikpal",
      sortOrder: 520,
      secondaryStatus: "Sleep · Stereoscenic · 256 kbps MP3",
      active: false
    }),
    buildRadioStation({
      id: "radio-1",
