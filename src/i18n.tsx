...
const dictionaries: Record<UiLocale, Record<string, string>> = {
  en: {
    ...
    "common.muted": "Muted",
    "common.needProxyOn": "Need Proxy On",
    "common.no": "No",
    "common.off": "Off",
...
Object.assign(dictionaries["zh-CN"], {
  "common.active": "正在使用", "common.add": "添加", "common.apply": "应用", "common.applying": "应用中...", "common.back": "返回", "common.cancel": "取消", "common.checkProxy": "检查代理", "common.checkSetup": "检查设置", "common.clear": "清除", "common.close": "关闭", "common.closing": "关闭中", "common.connected": "已连接", "common.connecting": "连接中", "common.current": "当前", "common.delete": "删除", "common.deleteQuestion": "删除？", "common.direct": "直连", "common.disabled": "已关闭", "common.enabled": "已启用", "common.experimental": "实验", "common.failed": "失败", "common.hidden": "隐藏", "common.loading": "加载中", "common.manual": "手动", "common.muted": "静音", "common.needProxyOn": "需要 Proxy On", "common.no": "否", "common.off": "关", "common.offline": "离线", "common.on": "开", "common.online": "在线", "common.opening": "打开中", "common.prewarming": "预热中", "common.proxy": "代理", "common.proxyOff": "Proxy Off", "common.proxyOn": "Proxy On", "common.ready": "就绪", "common.saving": "保存中", "common.savedAutomatically": "已自动保存", "common.scanning": "扫描中...", "common.syncing": "同步中", "common.unavailable": "不可用", "common.visible": "显示", "common.waiting": "等待中", "common.yes": "是",
  ...
  "explore.pickLeft": "在左侧选择音乐", "explore.noWebPlayer": "未打开网页播放器", "explore.chooseBelow": "从下面选择网页播放器", "explore.openLeft": "正在左侧打开", "explore.couldNotOpen": "无法打开", "explore.proxyActive": "代理已启用", "explore.proxyRequired": "打开 Proxy 后再进入这个播放器。", "explore.directConnection": "直连", "explore.footer": "在左侧选择音乐。Tikpal 控制保留在这里。", "explore.font": "字体", "explore.small": "小", "explore.medium": "中", "explore.large": "大",
