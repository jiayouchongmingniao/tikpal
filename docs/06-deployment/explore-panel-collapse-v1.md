...
The layout action takes the existing window lock without waiting behind another
foreground operation, verifies profile identities and the current session, and
revokes the prior Helper lease/watch before publishing Shell ownership. It
