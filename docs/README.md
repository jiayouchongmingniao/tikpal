...
- Tikpal-owned UI surfaces share a device language preference for English, Chinese, German, Italian, Korean, Japanese, and Spanish; the Gentoo physical kiosk also syncs Onboard/Fcitx defaults and Onboard keycap font from device preferences.
